<template>
  ...
  <div class="sm:ml-64 min-h-screen  text-gray-900 dark:text-gray-200">
      ...
      <div class="relative z-10 px-8 py-12">
        <div class="flex items-center gap-6"> 
          ...
          <button @click="goBack" class="bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm rounded-2xl p-3 shadow-lg border border-white/30 dark:border-gray-600/30 hover:shadow-xl transition-all duration-300 group">
            <i class="fa-solid fa-arrow-left text-gray-600 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors duration-300"></i>
          </button>
          ...
          <div class="bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm rounded-2xl p-4 shadow-xl border border-white/30 dark:border-gray-600/30">
            <i class="fas fa-user-edit fa-3x text-blue-600 dark:text-blue-400"></i>
          </div>
          
          <div>
            <h1 class="text-4xl font-bold text-gray-800 dark:text-white mb-2 tracking-tight">Edit Candidate</h1>
            <p class="text-lg text-gray-600 dark:text-gray-300 font-medium">Update the candidate profile information</p>
            <div class="flex items-center gap-4 mt-3">
              <div class="flex items-center gap-2 bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm rounded-full px-4 py-2">
                ...
                <span class="text-sm text-gray-700 dark:text-gray-300 font-medium">Edit Profile</span>
              </div>
              <div class="flex items-center gap-2 bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm rounded-full px-4 py-2">
    ...
    <div class="max-w-7xl mx-auto px-4 py-8 space-y-8">
      ...
      <div class="bg-white dark:bg-gray-700 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border border-white/20 dark:border-gray-700/50">
        <div class="flex flex-col lg:flex-row">
          ...
          <div class="w-full lg:w-1/2 p-8 lg:p-12">
            <div class="mb-8">
              ...
              <p class="text-gray-600 dark:text-gray-400">Update the candidate details below</p>
            </div>
            ...
            <form class="space-y-6">
              ...
              <div class="group">
                <label for="rollNo" class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 flex items-center gap-2">
                  ...
                  Roll Number <span class="text-gray-500 text-xs">(Read-only)</span>
                </label>
                <div class="relative">
                  <input 
                    v-model="form.rollno" 
                    type="text" 
                    id="rollNo" 
                    placeholder="Roll number (cannot be changed)"
                    class="w-full px-4 py-4 pl-12 border-2 border-gray-200 dark:border-gray-600 rounded-xl bg-gray-100 dark:bg-gray-600 text-gray-600 dark:text-gray-400 cursor-not-allowed transition-all duration-300"
                    readonly 
                  />
                ...
                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400 flex items-center gap-2">
                  ...
                  Roll number cannot be modified for data integrity
                </p>
              </div>
          ...
          <div class="w-full lg:w-1/2 p-8 lg:p-12 flex flex-col items-center justify-center border-t lg:border-t-0 lg:border-l border-gray-200 dark:border-gray-600">
            <div class="text-center mb-8">
              ...
              <p class="text-gray-600 dark:text-gray-400">See how the updated profile will appear</p>
            </div>
        ...
        <div class="px-8 lg:px-12 py-8 border-t border-gray-200 dark:border-gray-600 flex flex-col sm:flex-row justify-center gap-4">
          ...
          <button @click="updateCandidate" type="button" 
            class="px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2 font-semibold"
      ...
      <div v-if="errors.updateerror" class="bg-gradient-to-r from-red-50 to-pink-50 dark:from-red-900/20 dark:to-pink-900/20 border border-red-200 dark:border-red-800 rounded-2xl p-6 flex items-center gap-4 shadow-lg">
        ...
        <div>
          ...
          <p class="text-sm text-red-700 dark:text-red-300">{{ errors.updateerror }}</p>
        </div>
      </div>
    </div>
  </div>
