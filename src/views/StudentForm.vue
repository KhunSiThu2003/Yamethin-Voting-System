      ...
      <div v-if="isRegister && !registeredUser" class="mb-6">
        ...
        <form @submit.prevent="handleRegister">
          ...
          <div class="relative z-0 w-full mb-5 group">
            ...
            <p
              v-if="rollexample"
              class="absolute top-4 right-0 text-gray-400 text-xs"
            >
              {{ rollexample }}
            </p>
          </div>
          ...
          <p
            v-if="errorMessage"
            class="text-red-600 text-sm prose text-justify"
          >
            {{ errorMessage }}
          </p>
        ...
        <div class="mt-4 text-center">
          ...
          <button @click="toggleForm" class="text-blue-600 hover:text-blue-800">
            Login
          </button>
        </div>
      </div>
...
export default {
  ...
  setup() {
    ...
    const handleRegister = async () => {
      ...
      const isRollNoValid = await checkRollNo(
        userYear,
        userMajor,
        rollNo.value
      );
      ...
      const { addStudent } = studentRegister(
        fullname.value,
        rollNo.value,
        password.value,
        userYear,
