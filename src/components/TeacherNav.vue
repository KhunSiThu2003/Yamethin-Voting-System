...
export default {
  ...
  setup(props) {
    ...
    const showUserDetails = () => {
      ...
      Swal.fire({
        ...
        customClass: {
          ...
          confirmButton:
            "dark:bg-blue-600 dark:hover:bg-blue-700 text-xs sm:text-sm",
          cancelButton:
    ...
    // In your TeacherNav.vue component, add this method to the setup() function
    ...
    const showLoginForm = () => {
      ...
      <div class="space-y-4">
        ...
        <div class="mt-4 text-center">
          ...
          <a href="/teacherform" class="text-sm ${
            currentTheme === "dark"
    ...
    `,
        ...
        didOpen: () => {
          ...
          const registerLink = document.querySelector('a[href="/teacherform"]');
          if (registerLink) {
